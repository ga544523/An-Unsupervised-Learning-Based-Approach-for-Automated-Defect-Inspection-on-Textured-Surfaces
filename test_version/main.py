...
encoder_decoder512_optimizer = torch.optim.Adam(encoder_decoder512_net.parameters(), lr=0.0001,weight_decay=0.001)
encoder_decoder256_optimizer = torch.optim.Adam(encoder_decoder256_net.parameters(), lr=0.0001,weight_decay=0.001)
encoder_decoder128_optimizer = torch.optim.Adam(encoder_decoder128_net.parameters(), lr=0.0001,weight_decay=0.001)
